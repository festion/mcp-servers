...
# Restart
ssh jeremy@192.168.1.197 "echo '***SCRUBBED-T21B-SHARED-ADMIN-OR-WIFI-PSK***' | sudo -S systemctl restart birdnet-go.service"

# Edit config
ssh jeremy@192.168.1.197 "echo '***SCRUBBED-T21B-SHARED-ADMIN-OR-WIFI-PSK***' | sudo -S nano /root/birdnet-go-app/config/config.yaml"
```
...
# View recent clips
ssh jeremy@192.168.1.197 "echo '***SCRUBBED-T21B-SHARED-ADMIN-OR-WIFI-PSK***' | sudo -S ls -lht /root/birdnet-go-app/data/clips/ | head -10"
...
# Both services
ssh jeremy@192.168.1.197 "echo '***SCRUBBED-T21B-SHARED-ADMIN-OR-WIFI-PSK***' | sudo -S systemctl restart birdnet-go.service && systemctl restart bird-display.service"
```
...
ssh jeremy@192.168.1.197 "echo '***SCRUBBED-T21B-SHARED-ADMIN-OR-WIFI-PSK***' | sudo -S grep 'source:' /root/birdnet-go-app/config/config.yaml"
...
ssh jeremy@192.168.1.197 "echo '***SCRUBBED-T21B-SHARED-ADMIN-OR-WIFI-PSK***' | sudo -S systemctl restart docker"
sleep 5
ssh jeremy@192.168.1.197 "echo '***SCRUBBED-T21B-SHARED-ADMIN-OR-WIFI-PSK***' | sudo -S systemctl restart birdnet-go.service"

# 2. Config syntax error
ssh jeremy@192.168.1.197 "echo '***SCRUBBED-T21B-SHARED-ADMIN-OR-WIFI-PSK***' | sudo -S cat /root/birdnet-go-app/config/config.yaml | grep -E 'source:|interval:|threshold:'"
...
echo ''
echo '=== Disk Usage ==='
echo '***SCRUBBED-T21B-SHARED-ADMIN-OR-WIFI-PSK***' | sudo -S du -sh /root/birdnet-go-app/data/clips/
"
```
...
# Restart BirdNET-Go
echo '***SCRUBBED-T21B-SHARED-ADMIN-OR-WIFI-PSK***' | sudo -S systemctl restart birdnet-go.service
...
echo '***SCRUBBED-T21B-SHARED-ADMIN-OR-WIFI-PSK***' | sudo -S nano /root/birdnet-go-app/config/config.yaml
```
