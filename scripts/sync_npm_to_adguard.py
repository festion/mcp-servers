...
<<<<<<< HEAD
ADGUARD_USER = "root"
ADGUARD_PASS = "***SCRUBBED-T21B-SHARED-ADMIN-OR-WIFI-PSK***"  # 🔒 replace with your actual password
=======
ADGUARD_USER = "admin"
...
def main():
    parser = argparse.ArgumentParser(description="Sync AdGuard DNS rewrites from NPM internal domains.")
